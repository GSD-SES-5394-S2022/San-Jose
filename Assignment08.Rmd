...
ggplot(convergence_points) +
  ...
  scale_x_continuous(name = "Iteration",
                     breaks = breaks <- seq(0, 25000, by=2000),
                     labels = formatC(breaks, 
                                      big.mark = ",", 
                                      format = "f", 
                                      digits = 0)) +
...
ggplot(desire_lines_coord_all_combined[order(-desire_lines_coord_all_combined$hbo_flow_dif),]) +
...
ggplot(desire_lines_coord_all_combined[order(-desire_lines_coord_all_combined$hbw_flow_dif),]) +
...
ggplot(desire_lines_coord_all_combined[order(desire_lines_coord_all_combined$nhb_flow_dif),]) +
  geom_sf(data = zone_boundaries, color = alpha("black", .3), fill = "grey35") +
  geom_curve(aes(x = X, y = Y, xend = X.1, yend = Y.1,

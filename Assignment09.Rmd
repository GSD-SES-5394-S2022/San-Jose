...
# HBO
SOV_const_HBO <- -0.923  #-0.92343
HOV_const_HBO <- -0.2 #0.02259229
transit_const_HBO <- -2.2 #-4.067441
walk_const_HBO <- -0.1 #-1.606334
bike_const_HBO<- -2.1 #-3.616955
 
# HBW
SOV_const_HBW <- 0.8 #1.132976
HOV_const_HBW <--0.7 #-2.108496
transit_const_HBW <--0.02 #-3.033151
walk_const_HBW <-0.02 #-3.572114
bike_const_HBW<--0.02  #-2.715594

# NHB
SOV_const_NHB <- -0.55 # -0.5024781
HOV_const_NHB <--0.5 #-0.3174682
transit_const_NHB <- -0.7 #-3.409766
walk_const_NHB <-0.01 #-1.711975
bike_const_NHB<- -2.0 #-4.066457

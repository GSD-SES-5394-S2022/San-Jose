...
#create choropleth map for existing
```{r, message=F, echo=F, warning=F}
existing_map <- chor_map(access_compare, "ratio", 
                            title = "Existing condition comparison for driving and transit")

# recall choropleth from accessibility?
# add centroids map where size is the number of jobs

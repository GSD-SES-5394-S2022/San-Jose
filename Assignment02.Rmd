...
o	Reduce number of service jobs (make note not actually reducing jobs, just commuting), and reduce number of people who don’t work from home and increase num of people who do work 

things to do:
- ACS variables on people who work from home and people who don't, existing dataset
- alt dataset:
  - Decrease people who don't work from home by 40% and add that value to people who do WFH
  - decrease the amount of service jobs by 40%
...
chlor_map(census_alt, "commuter_change", pal = map_color, 
          title = "Commuters\nTransitioned\nto WFH")
...
chlor_map(census_alt, "jobs_change", pal = map_color7,

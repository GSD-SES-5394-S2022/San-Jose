...
```{r}
existing <- write_csv(census, "existing/existing_sanjose.csv")
existing_spatial <- st_write(census, "existing/existing_sanjose.geojson")
zones_sanjose <- st_write(tracts, "zones/zones_sanjose.geojson", append = F)
